...
/* 
    This example attempts to demonstrates how to write to 2D OpenGL textures
    using CUDA surfaces

	The steps are:
	1. Create an OpenGL 2D Texture
...
int main(int argc, char** argv)
{
	...
	CHECK_CUDA(cudaGraphicsGLRegisterImage(&cuda_image_resource, 
                                           texID, GL_TEXTURE_2D, cudaGraphicsRegisterFlagsSurfaceLoadStore));
...
void checkTex()
{
	int numElements = textureDim.x*textureDim.y*4;
